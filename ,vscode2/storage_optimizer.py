...
st.caption("Intelligent Storage Optimization Engine")

st.divider()

st.subheader("Choose input method")

folder_path = st.text_input("Scan folder (for local use)")
uploaded_files = st.file_uploader(
    "OR upload files (for cloud deployment)",
...
if scan:
    ...
    for f in files_data:
        ...
        st.write(
            f"{f['name']} | {f['size_kb']} KB | score {f['score']} | {f['destination']}"
        )